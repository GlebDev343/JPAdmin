...
/**
 * Custom Hibernate UserType for mapping PostgreSQL BIT type to a Java String.
 * <p>
 * This type maps PostgreSQL BIT columns, which store fixed-length bit strings, to Java strings.
 * The value must consist only of '0' and '1' characters, e.g., "101" or "101010".
 */
public class BitStringType implements UserType<String> {
